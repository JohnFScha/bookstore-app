...
const BookSingleCard = ({ book }) => {
  ...
  return (
    <article
      key={book._id}
      className="border-2 border-gray-500 rounded-lg px-4 py-2 m-4 relative hover:shadow-xl flex flex-col justify-between"
    >
      ...
      <div className="flex justify-start items-center gap-x-2">
        ...
        <h4 className="my-1">{book.author.substring(0, 15)}...</h4>
      </div>
